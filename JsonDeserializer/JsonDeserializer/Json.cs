            ...
            try {
                ...
                if (Response.Documents != null) {
                    for (int i = 0; i < Response.Documents.Length; i++) {
                        Response.Documents[i].Date = DateTime.Parse(Response.MetaData.Parameter.Date);
                        Response.Documents[i].Id = int.Parse(Response.Documents[i].Date.ToString("yyMMdd")) * 10000 + Response.Documents[i].SeqNumber;
...
namespace Edinet.Json {
    ...
    [DataContract]
    public class Metadata : Infomation {
